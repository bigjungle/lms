...
**[有哪些类似 EduSoho 的产品?](https://www.zhihu.com/question/21678268)**

看到EduSoho, 开源软件, 帮助老师搭建自己的教育网站, 演示站: EDUSOHO测试站 觉得这个产品挺棒, 想知道还有无类似产品: 开源+用来搭建在线课程 thanks
关注者
262
被浏览
27,825
...
字幕组组长带你无字幕看剧
目前我所知道的
0 Edusoho, 门槛较低, 相当于让每个老师做一个自己的小的好知网
1 多贝提供的网校通 多贝网校通, 门槛低, 相当于让每个老师做一个自己的小的多贝网
2 Edx 这是python, 门槛颇高
3 我觉得应该仔细思考自己核心功能是什么? 比如你的核心功能是短视频播放和互动, 或许微信服务账号可以作为你的MVP版本产品
发布于 2013-11-20
五十猫
五十猫
Hello Hell
用Joomla+moodle或者blackboard,或者Guru可以搭建个简单的在线课程网站；加上一些测试quiz模块，有兴趣可以联系沟通下。
发布于 2013-10-23
国民学渣
国民学渣
“好好学习，天天向上”

类似EduSoho的产品还有EDX、eduline等开源平台；

但是从个人来说，还是建议你可以考虑一下采用SaaS工具来搭建自己的在线教育平台，例如短书、小鹅通这种类型的平台，对于老师而言会更容易管理和使用。

EduSoho开源网络课堂是教育培训系统软件，可以提供在线学习辅导解决方案，用户可以按需购买，自由扩容。但相对来说开源的方式也具有一定的弊端，例如产品更新的速度慢、缺少系统化支持、配置搭建环境繁琐等问题，对于在编程搭建领域零基础的用户而言，使用开源的产品简直是难上加难，其具体过程往往并没有介绍中的那么简单。

1、开源的产品往往缺少一个系统化的支持，比如文档不全，没有好的IDE工具，有时候遇到问题你都不知道找谁，社区回复特别的慢。这是开源产品目前存在比较闹心的问题，EduSoho会不会有这种情况我不敢保证，但如果你是订购例如短书这样的SaaS在线教育工具平台的话，就很少出现这种问题，因为在你订购后他们会有专属的客服来跟你对接的，相对来说，如果在使用的过程中遇到问题的话，你也可以更好的进行解决。

2、开源的东西往往需要配置、配置、配置，手动编译，现在有很多开源的产品软件，经过好几次的安装，才能使用，非常不人性化。在使用开源产品前，你还需要花费大量的时间和精力在各种配置和安装上面。而使用SaaS工具就不会有这方面的顾虑，你只需要注册账号，然后把课程上传到平台上面就可以了，而且还支持一键生成微信小程序，对于学生来说听课也变得更加的方便高效，不用再去下载第三方的App软件，直接在微信就可上课。

3、产品功能层面更新迭代时间周期长，真正使用过开源产品的用户都知道，在更新迭代这方面是非常闹心的，因为大部分开源的产品都是很长时间都不更新，或者隔了一两个月才更新些皮毛，并无重大功能层面的改动。但如果你用的是短书，那就不一样了。

我跟你简单说说在近一个月短书都更新了哪些内容：

    新增积分系统与积分商城；课程优化：支持音视频连续播放、倍速播放，学员可自由调整；新增多级分类，使你的内容展示更加的清晰；底部导航栏自定义，可根据不同场景切换使用导航栏；.....

这些更新都是在一个月内进行的，其功能迭代的速度比开源的产品要快很多，而且在基于微信生态环境下，教师的在线教育还可以更多进行拓展生源，拼团、限时购、推广海报等营销方式，也帮助教师机构们更好的进行营销促销活动。
